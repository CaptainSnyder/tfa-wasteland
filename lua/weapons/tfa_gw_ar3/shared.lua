...
SWEP.Purpose = "A high-cycle squad automatic. Accuracy is a suggestion."
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/40watt/plasma3.wav")
...
SWEP.TracerName = "Weapon_LaserSMG_Rail"
SWEP.TracerPCF = true
...
-- no wattage in the name; 18 damage matches the 80 Watt but it fires 3x faster, so it is charged as a 60 rather than an 80
...
SWEP.Primary.IronAccuracy = 0.038 * 0.35
