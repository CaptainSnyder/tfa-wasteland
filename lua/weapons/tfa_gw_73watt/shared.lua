...
SWEP.PrintName = "Phase X Watt 73"
SWEP.Author = "Annoying Rooster"
SWEP.Purpose = "A phased-array rifle firing tight, repeating bursts of energy."
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/75watt/75watt.wav")
...
SWEP.Primary.RPM = 353
SWEP.Primary.RPM_Semi = 353
...
SWEP.TracerName = "Weapon_Strawberry_Rail"
SWEP.TracerPCF = true
...
SWEP.Primary.IronAccuracy = 0.022 * 0.35
