...
SWEP.PrintName = "Stent Nine"
SWEP.Author = "Annoying Rooster"
SWEP.Purpose = "A compact plasma submachine gun."
...
-- no wattage in the name; 17 damage puts it just under the 75 Watt, so it is charged as a 60
...
SWEP.Primary.IronAccuracy = 0.032 * 0.35
