...
SWEP.PrintName = "80 Watt Power-15Z"
SWEP.Author = "Annoying Rooster"
SWEP.Purpose = "A heavy, slow-cycling plasma platform built for suppression."
...
-- 80 watts, so 4 charges a shot - the heaviest draw in the pack
